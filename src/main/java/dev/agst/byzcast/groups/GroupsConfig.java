...
public class GroupsConfig {
  ...
  /**
   * Returns the next group to traverse to reach the target group from the starting group.
   *
   * @param start the starting group
   * @param target the target group
   * @return the next group to traverse, or null if there is no path from start to target
   */
