...
/**
 * The GroupsConfigLoader class is responsible for loading group configurations from a JSON file.
 */
public class GroupsConfigLoader {
  ...
  /**
   * Loads a group configuration from a JSON file. The expected format of the JSON file is an array
   * of objects, where each object represents a group with a "groupID" and an "associatedGroups"
   * array. For example:
   *
   * <pre>
   * [
  ...
  public GroupsConfig loadFromJson(String filePath) throws IOException, InvalidConfigException {
    ...
    try {
      ...
      throw new InvalidConfigException(
          "Configuration file " + filePath + " is invalid: " + e.toString());
    }
